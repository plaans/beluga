...
# NOTE: Usage: make run-solve MAXSWAPS=5 PBBASE="example_problems/test01a_base.json" PBPROPS="example_problems/test01a_props.json"
run-solve:
	apptainer exec beluga-apptainer.sif /usr/src/beluga/beluga.py solve $(MAXSWAPS) $(PBBASE) $(PBPROPS)
